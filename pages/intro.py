...
with st.container(border=True):
    st.header('Purpose')
    st.text('People uses body gestures when speaking, also called co-speech gestures.')
    ...
    st.text('Your response will be considered when making co-speech gesture production systems for digital avatars or robots. We are greatful that you will provide your genuien opinion!')
    ...
    st.text('There are two types of videos: One is without audio, the other one has audio. The purpose of excluding the audio is to allow you to focus on the gesture movements itself, insteading of being affected by the speech.')
    st.text('For the videos without audio, the question is: "Which of the gestures do you think is more natural in terms of human-likeness, smoothness and comfortablenss?" For the videos with audio, the question is: "Which of the gestures do you think synchronize more with the spoken utterance?"')
    ...
    st.text('- You can use zoom in/our of your browser if you find the window is too large/small.')
