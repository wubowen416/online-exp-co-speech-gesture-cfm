...
with st.container(border=True):
    ...
    st.warning(
        'We have included simple questions for checking your attention to ensure the responses are reasonable. However, it is very simple that you will not fail as long as you are not choosing randomly.'
    )
